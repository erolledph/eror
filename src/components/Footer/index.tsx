        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark font-medium">
              &copy; {year}. All rights reserved by TechMart.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="flex flex-wrap items-center gap-6">
                <a href="#" aria-label="payment system with visa card">
                  <div className="bg-gray-3 px-4 py-2 rounded text-xs">VISA</div>
                </a>
                <a href="#" aria-label="payment system with paypal">
                  <div className="bg-gray-3 px-4 py-2 rounded text-xs">PayPal</div>
                </a>
                <a href="#" aria-label="payment system with master card">
                  <div className="bg-gray-3 px-4 py-2 rounded text-xs">MasterCard</div>
                </a>
                <a href="#" aria-label="payment system with apple pay">
                  <div className="bg-gray-3 px-4 py-2 rounded text-xs">Apple Pay</div>
                </a>
                <a href="#" aria-label="payment system with google pay">
                  <div className="bg-gray-3 px-4 py-2 rounded text-xs">Google Pay</div>
                </a>
              </div>
            </div>
          </div>
